...
const CT_ecb_b64 = `CRIwqt4+szDbqkNY+I0qbDe3LQz0wiw0SuxBQtAM5TDdMbjCMD/venUDW9BL
...
const key_ecb = 'YELLOW SUBMARINE';

const decipher_ecb = createDecipheriv("aes-128-ecb", key_ecb, null);
let pt = Buffer.concat([decipher_ecb.update(CT_ecb_b64, "base64"), decipher_ecb.final()]);
console.log(pt.toString());

const key = randomBytes(24);

const ciph = createCipheriv('aes-192-ctr', key, randomBytes(24));